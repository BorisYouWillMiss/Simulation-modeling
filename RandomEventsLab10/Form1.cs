namespace RandomEventsLab10
{
    public partial class player6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (button1.Text == "Quarter final")
            {
                button1.Text = "Semi final";
            ...
            else if (button1.Text == "Semi final")
            {
                button1.Text = "Finale";
            ...
            else if (button1.Text == "Finale")
            {
                ...
                if (playerScore[0] > playerScore[1])
                    champion.Text = finaleNames[0] + " is a new Champion!";
                else champion.Text = finaleNames[1] + " is a new Champion!";
            }
            else if (button1.Text == "Renew")
            {
                button1.Text = "Start";
